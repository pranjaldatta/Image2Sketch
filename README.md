...
* *STEP 3: Get the pre-trained weights*
   ...
   Download the pretrained weights from [here](https://drive.google.com/drive/folders/1ovP_b8Hy0je7M2wP-bTf2eG1N_txfTSl?usp=sharing), extract and place it in the /src/pytorch-CycleGAN-and-pix2pix/checkpoints/sketch_pix2pix
